...
※ちなみに、この最新の変更履歴だけダウンロードすることをプルと言います。  
...
※上の手順では、普通のチーム開発ではプッシュすることができません。
今回は、他の人が、あなたが作業しているブランチを変更することは無いので上のやり方でプッシュできます。  
本来のやり方を書くとまた長くなってしまうので、割愛します。
...
ですが、これからが本番です。  
みんなの目的は問題が解けることです。  
この解説はそれをできるだけストレスなくスムーズにできるようにするためのものでした。

さあ、それでは問題を解いて下さい！

みんなが今回の問題を通して、一歩成長できるよう、健闘を祈ります。
